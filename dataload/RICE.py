...
class TrainDataset(data.Dataset):
    ...
    def __init__(self, config, isTrain=True):
        ...
        self.config = config
        if(isTrain):
            self.datasets_dir = 'E:/cloudremovedata/dataselfexperment-singleimage/RICE_DATASET/' + config.datasets_dir +'/train'     #'/xxxx/' + config.datasets_dir+'/train' #change to the path of your dataset
        else:
            self.datasets_dir = 'E:/cloudremovedata/dataselfexperment-singleimage/RICE_DATASET/' + config.datasets_dir + '/test'  #'/xxx/' + config.datasets_dir+'/test'
